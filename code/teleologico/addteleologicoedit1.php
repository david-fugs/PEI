...
<body>
   	...
   	<?php
	    ...
	    if(isset($_POST['btn-update']))
        {
            ...
            $fecha_edit_ct      =   date('Y-m-d h:i:s');
            $id_usu             =   $_SESSION['id'];
           
            $update = "UPDATE componente_teleologico SET mision_ct='".$mision_ct."', vision_ct='".$vision_ct."', per_egr_ct='".$per_egr_ct."', obj_ins_ct='".$obj_ins_ct."', obs_ct='".$obs_ct."', id_cole='".$id_cole."', fecha_edit_ct='".$fecha_edit_ct."', id_usu='".$id_usu."' WHERE id_ct='".$id_ct."'";
