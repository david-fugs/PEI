...
$sql = "SELECT * FROM componente_teleologico WHERE id_cole = '$id_cole'";
  ...
  <section class="principal">
    ...
    <div style="border-radius: 9px 9px 9px 9px; -moz-border-radius: 9px 9px 9px 9px; -webkit-border-radius: 9px 9px 9px 9px; border: 4px solid #FFFFFF;" align="center">
      ...
      <div align="center">
        ...
        <h1 style="color: #412fd1; font-size: 30px; text-shadow: #FFFFFF 0.1em 0.1em 0.2em"><b><i class="fas fa-folder-open"></i> DOCUMENTOS DEL COMPONENTE TELEOLÓGICO </b></h1>
      ...
      ?>
      <center>
        <a href="addteleologico.php" class="btn btn-secondary d-inline-flex align-items-center gap-2">
