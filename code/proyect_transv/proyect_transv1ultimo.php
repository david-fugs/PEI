...
<html lang="es">
    ...
    <div class="container">
        ...
        <form action='proyect_transv2.php'method="POST">
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-6">
                            ...
                            <select class="form-control" name="selec_proyec_transv" required id="selectProy">
                                ...
                                <option value="EDUCACION AMBIENTAL PRAE">PROYECTO PARA EL EJERCICIO DE LOS DERECHOS HUMANOS</option>
                                <option value="EDUCACION ECONOMICA Y FINANCIERA">PROYECTO DE EDUCACIÓN VIAL </option>                                
                            </select>
                        </div>
                    </div>
                </div>
            ...
            <input type='number' name='num_est_trans' class='form-control' required required value=0 style="text-transform:uppercase;" />
                      
            <label for="num_est_pri">Primaria:</label>
          
            <input type='number' name='num_est_pri' class='form-control' required value=0 required value=0 style="text-transform:uppercase;" /> 

            <label for="nombre_tipo_proy_trans">Secundaria:</label>
          
            <input type='number' name='num_est_secun' class='form-control' required value=0 style="text-transform:uppercase;" />

            <label for="nombre_tipo_proy_trans">Media:</label>
          
            <input type='number' name='num_est_media' class='form-control' required value=0 style="text-transform:uppercase;" />
            ...
            <label for="nombre_tipo_proy_trans">Internacionales:</label>
               ...
               <input type='text' name='inter_doc' class='form-control' required value=0 style="text-transform:uppercase;" /> 

            <label for="nombre_tipo_proy_trans">Nacionales:</label>
          
               <input type='text' name='nac_doc' class='form-control' required value=0 style="text-transform:uppercase;" /> 

            <label for="nombre_tipo_proy_trans">Departamentales:</label>
          
               <input type='text' name='dep_doc' class='form-control' required value=0 style="text-transform:uppercase;" /> 

            <label for="nombre_tipo_proy_trans">Locales:</label>
          
               <input type='text' name='local_doc' class='form-control' required value=0 style="text-transform:uppercase;" /> 

            <label for="nombre_tipo_proy_trans">Institucionales:</label>
          
               <input type='text' name='insti_doc' class='form-control' required value=0 style="text-transform:uppercase;" />
            ...
            <input type='text' name='inter_doc_norm' class='form-control' required value=0 style="text-transform:uppercase;" /> 

            <label for="nombre_tipo_proy_trans">Nacionales:</label>
          
            <input type='text' name='nac_doc_norm' class='form-control' required value=0 style="text-transform:uppercase;" /> 

            <label for="nombre_tipo_proy_trans">Departamentales:</label>
          
            <input type='text' name='dep_doc_norm' class='form-control' required value=0 style="text-transform:uppercase;" /> 

            <label for="nombre_tipo_proy_trans">Locales:</label>
          
            <input type='text' name='local_doc_norm' class='form-control' required value=0 style="text-transform:uppercase;" /> 

            <label for="nombre_tipo_proy_trans">Institucionales:</label>
          
            <input type='text' name='insti_doc_norm' class='form-control' required value=0 style="text-transform:uppercase;" />
            ...
            <input type='number' name='num_anos_implem' class='form-control' required value=0 style="text-transform:uppercase;" />  
            ...
            <div class="form-group">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <textarea class="form-control" rows="3" name="Tem_curr_proy" required value=0 style="text-transform:uppercase;" cols="123" ></textarea>
                        </div>
                    </div>
                </div>
             <hr style="border: 2px dotted #909797; border-radius: 1px;">
            ...
            <div class="form-group">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <textarea class="form-control" rows="3" name="Prob_curr_proy" required value=0 style="text-transform:uppercase;" cols="123" ></textarea>
                        </div>
                    </div>
                </div> 
            ...
            <div class="form-group">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <textarea class="form-control" rows="3" name="activ_curr_proy"required value=0 style="text-transform:uppercase;" cols="123" ></textarea>
                        </div>
                    </div>
                </div>
            ...
            <div class="form-group">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <textarea class="form-control" rows="3" name="otros" required value=0 style="text-transform:uppercase;" cols="123" ></textarea>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 col-sm-3">
                            <label for="fecha_seg">Fecha de actualización del proyecto:</label>
                             <input type='date' name='fec_act_proyecto' required value='<?php echo $fecha;?>' class='form-control' />
            ...
            <input type='number' name='num_est_vin_23' class='form-control' required value=0 style="text-transform:uppercase;" />
                 ...
                 <div class="form-group">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <textarea class="form-control" rows="3" name="cuent_for_proyec" required value=0 style="text-transform:uppercase;" cols="123" ></textarea>
                        </div>
                    </div>
                </div>
            ...
            <label for="nombre_tipo_proy_trans">Nombre del curso:</label>
             <input type='text' name='nom_curs_form_capac' required value=0 class='form-control' style="text-transform:uppercase;" />
            ...
            <div class="form-group">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <textarea class="form-control" rows="3" name="si_fue_cert_num_anos" required value=0 style="text-transform:uppercase;" cols="123" ></textarea>
                        </div>
                    </div>
                </div>
                <hr style="border: 2px dotted #909797; border-radius: 1px;">                
            ...
            <input type='text' name='sena_anos_art' required value=0 class='form-control' style="text-transform:uppercase;" />
            ...
            <input type='text' name='int_nac_dep_art' required value=0 class='form-control' style="text-transform:uppercase;" />
            ...
            <div class="form-group">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <textarea class="form-control" rows="3" name="corp_jud_leg" required value=0 style="text-transform:uppercase;" cols="123" ></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <textarea class="form-control" rows="3" name="sec_jud_leg" required value=0 style="text-transform:uppercase;" cols="123" ></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <textarea class="form-control" rows="3" name="dep_jud_leg" required value=0 style="text-transform:uppercase;" cols="123" ></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <textarea class="form-control" rows="3" name="de_cont_dif_edu" required value=0 style="text-transform:uppercase;" cols="123" ></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <textarea class="form-control" rows="3" name="cent_jud_leg" required value=0 style="text-transform:uppercase;" cols="123" ></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <textarea class="form-control" rows="3" name="org_priv_depto" required value=0 style="text-transform:uppercase;" cols="123" ></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <textarea class="form-control" rows="3" name="org_com_depto" required value=0 style="text-transform:uppercase;" cols="123" ></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <textarea class="form-control" rows="3" name="otras_depto" required value=0 style="text-transform:uppercase;" cols="123" ></textarea>
                        </div>
                    </div>
                </div>
        ...
        <p align="justify"><font size=4 color=#000000 style="font-family: georgia; font-size: 18px;">Apoyo externo recibido:</font></p>
            ...
            <input type='text' name='inst_nom_apoy_ext' required value=0 class='form-control' style="text-transform:uppercase;" />

            <hr style="border: 2px dotted #909797; border-radius: 1px;">

            <label for="num_anos_apoy">Numero de año de apoyo:</label>
          
            <input type='number' name='num_anos_apoy' required value=0 class='form-control' style="text-transform:uppercase;" />
            ...
            <input type='text' name='fin_tip_apoy'required value=0 class='form-control' style="text-transform:uppercase;" />

            <label for="log_tip_apoy">Logistico</label>          
            <input type='text' name='log_tip_apoy'required value=0 class='form-control' style="text-transform:uppercase;" />
                     
            <label for="tecn_tip_apoy">Tecnológico</label>            
            <input type='text' name='tecn_tip_apoy'required value=0 class='form-control' style="text-transform:uppercase;" />
            
            <label for="tec_peda_tip_apoy">Técnico pedagogico</label>
            <input type='text' name='tec_peda_tip_apoy'required value=0 class='form-control' style="text-transform:uppercase;" />
          
            <label for="ases_tip_apoy">Asesoria</label>
            <input type='text' name='ases_tip_apoy'required value=0 class='form-control' style="text-transform:uppercase;" />
          
            <label for="acomp_tip_apoy">Acompañamiento</label>
            <input type='text' name='acomp_tip_apoy'required value=0 class='form-control' style="text-transform:uppercase;" />
          
            <label for="sin_tip_apoy">Sin apoyo</label>
            <input type='text' name='sin_tip_apoy'required value=0 class='form-control' style="text-transform:uppercase;" />
            ...
            <input type='text' name='fin_nec_proy'required value=0 class='form-control' style="text-transform:uppercase;" />

            <label for="log_nec_proy">Logistica</label>          
            <input type='text' name='log_nec_proy'required value=0 class='form-control' style="text-transform:uppercase;" />

            
            <label for="tec_nec_proy">Tecnológica</label>            
            <input type='text' name='tec_nec_proy'required value=0 class='form-control' style="text-transform:uppercase;" />
            ...
            <input type='text' name='tecn_pedag_nec_proy'required value=0 class='form-control' style="text-transform:uppercase;" />
          
            <hr style="border: 2px dotted #909797; border-radius: 1px;">


            <label for="ases_direc_doc_nec_proy">Asesoría a directivos docentes</label>
            <input type='text' name='ases_direc_doc_nec_proy'required value=0 class='form-control' style="text-transform:uppercase;" />
          
            

            <label for="acomp_nec_proy">Acompañamiento</label>
            <input type='text' name='acomp_nec_proy'required value=0 class='form-control' style="text-transform:uppercase;" />

            <label for="no_se_req_nec_proy">No se requiere</label>
            <input type='text' name='no_se_req_nec_proy'required value=0 class='form-control' style="text-transform:uppercase;" />
            ...
            <input type='number' name='log_ano_ult'required value=0 class='form-control' style="text-transform:uppercase;" />

            <label for="tecn_ano_ult">Tecnología</label>          
            <input type='number' name='tecn_ano_ult'required value=0 class='form-control' style="text-transform:uppercase;" />
            
            <label for="ases_ano_ult">Asesoría</label>            
            <input type='number' name='ases_ano_ult'required value=0 class='form-control' style="text-transform:uppercase;" />
            
            <label for="fin_ano_ult">Financiera</label>
            <input type='number' name='fin_ano_ult'required value=0 class='form-control' style="text-transform:uppercase;" />
          
            <label for="form_doc_año_ult">Formación docente(especifique el (los) temas:</label>
            <input type='number' name='form_doc_ano_ult'required value=0 class='form-control' style="text-transform:uppercase;" />
          
            <label for="tec_pedag_año_ult">Técnico pedagógico (especifique el (los) temas :</label>
            <input type='number' name='tec_pedag_ano_ult'required value=0 class='form-control' style="text-transform:uppercase;" />
          
            <label for="otro_ano_ult">Otros (¿Cual?)</label>
            <input type='number' name='otro_ano_ult'required value=0 class='form-control' style="text-transform:uppercase;" />

            <hr style="border: 2px dotted #909797; border-radius: 1px;">

            <label for="no_requie_eficaz">No se requiere</label>
            <input type='text' name='no_requie_eficaz'required value=0 class='form-control' style="text-transform:uppercase;" />
