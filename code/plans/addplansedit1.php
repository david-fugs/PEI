...
<body>
   	...
   	<?php
	    ...
	    if(isset($_POST['btn-update']))
        {
            ...
            $update = "UPDATE proyectos_transversales SET nombre_proy_plan='".$nombre_proy_plan."', tipo_proy_plan='".$tipo_proy_plan."', obs_proy_plan='".$obs_proy_plan."', id_cole='".$id_cole."', $fecha_edit_proy_plan ='".$$fecha_edit_proy_plan ."', id_usu='".$id_usu."' WHERE id_proy_plan='".$id_proy_plan."'";

            $up = mysqli_query($mysqli, $update);
 
            $id_insert = $id_proy_plan;
