     ...
     <section class="principal">
      ...
      <div style="border-radius: 9px 9px 9px 9px; -moz-border-radius: 9px 9px 9px 9px; -webkit-border-radius: 9px 9px 9px 9px; border: 4px solid #FFFFFF;" align="center">
        ...
        <div align="center">
          ...
          <h1 style="color: #412fd1; font-size: 30px; text-shadow: #FFFFFF 0.1em 0.1em 0.2em"><b><i class="fas fa-folder-open"></i> DOCUMENTOS MALLAS CURRICULARES - PLANES DE ASIGNATURA </b></h1>
