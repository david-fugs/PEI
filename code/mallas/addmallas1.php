...
?>
		...
		<div class="container">
			<h1><b><i class="fas fa-clipboard-list"></i> MALLAS CURRICULARES - PLANES DE ASIGNATURA</b></h1>
			<p><i><b><font size=3 color=#c68615>*Datos obligatorios</i></b></font></p>

			<form action='addmallas2.php' enctype="multipart/form-data" method="POST">
                ...
                <div class="form-group">
	                <div class="row">
	                    <div class="col-12 col-sm-12">
	                        ...
	                        <textarea class="form-control" rows="5" name="obs_gen_mc" style="text-transform:uppercase;" ></textarea>
                    	</div>
	                </div>
            	</div>
