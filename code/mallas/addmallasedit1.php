...
<body>
   	...
   	<?php
        ...
        {
            $id_mc              =   $_POST['id_mc'];
            $obs_malla_mc       =   strtoupper($_POST['obs_malla_mc']);
            $obs_plan_mc        =   strtoupper($_POST['obs_plan_mc']);
            $obs_gen_mc         =   strtoupper($_POST['obs_gen_mc']);
            $id_cole            =   $_POST['id_cole'];
            $fecha_edit_mc      =   date('Y-m-d h:i:s');
            $id_usu             =   $_SESSION['id'];
           
            $update = "UPDATE mallas_curriculares SET obs_malla_mc='".$obs_malla_mc."', obs_plan_mc='".$obs_plan_mc."', obs_gen_mc='".$obs_gen_mc."', id_cole='".$id_cole."', fecha_edit_mc='".$fecha_edit_mc."', id_usu='".$id_usu."' WHERE id_mc='".$id_mc."'";
