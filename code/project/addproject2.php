<?php
   ...
   $sql = "INSERT INTO proyectos_transversales (nombre_proy_trans, tipo_proy_trans, nombre_tipo_proy_trans, obj_proy_trans, sos_proy_trans, des_proy_trans, gra_0_proy_trans, gra_1_proy_trans, gra_2_proy_trans, gra_3_proy_trans, gra_4_proy_trans, gra_5_proy_trans, gra_6_proy_trans, gra_7_proy_trans, gra_8_proy_trans, gra_9_proy_trans, gra_10_proy_trans, gra_11_proy_trans, obs_proy_trans, id_cole, fecha_alta_proy_trans, fecha_edit_proy_trans, id_usu) values ('$nombre_proy_trans', '$tipo_proy_trans', '$nombre_tipo_proy_trans', '$obj_proy_trans', '$sos_proy_trans', '$des_proy_trans', '$gra_0_proy_trans','$gra_1_proy_trans','$gra_2_proy_trans','$gra_3_proy_trans', '$gra_4_proy_trans', '$gra_5_proy_trans', '$gra_6_proy_trans', '$gra_7_proy_trans','$gra_8_proy_trans', '$gra_9_proy_trans', '$gra_10_proy_trans', '$gra_11_proy_trans', '$obs_proy_trans', '$id_cole', '$fecha_alta_proy_trans', '$fecha_edit_proy_trans', '$id_usu')";
