...
CREATE TABLE IF NOT EXISTS `convivencia_escolar` (
  ...
  `tipo_documento` enum('conformacion','reglamento','actas','planes_accion') NOT NULL,
...
MODIFY `tipo_documento` enum('conformacion','reglamento','actas','planes_accion') NOT NULL COMMENT 'Tipo de documento: conformación, reglamento, actas o planes de acción',
