...
<body >
   	<?php
	    ...
	    $id_dllo_integ  = $_GET['id_dllo_integ'];
	    if(isset($_GET['id_dllo_integ']))
	    {
	       $sql = mysqli_query($mysqli, "SELECT * FROM dllo_integ WHERE id_dllo_integ = '$id_dllo_integ'");
    ...
    ?>
   	...
   	<div class="container">
        ...
        <BR/>
        <h1><b><i class="fas fa-baby"></i> ACTUALIZAR INFORMACIÓN SEGUIMIENTO AL DESARROLLO INTEGRAL </b></h1>
        <p><i><b><font size=3 color=#c68615>*Datos obligatorios</i></b></font></p>
    
        <form action='addintegraledit1.php' enctype="multipart/form-data" method="POST">
            <div class="row">
                <div class="col">
                    <input type="number" name='id_dllo_integ' class='form-control' hidden value='<?php echo $row['id_dllo_integ']; ?>' />
                </div>  
            </div>
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-12 col-sm-12">
                        <label for="obs_dllo_integ">OBSERVACIONES y/o COMENTARIOS ADICIONALES: (número de caracteres permitido-> <span></span>)</label>
                        <textarea class="form-control" rows="5" cols="56" name="obs_dllo_integ" maxlength="10000" style="text-transform:uppercase;" /><?php echo $row['obs_dllo_integ']; ?></textarea>
                    </div>
                </div>
            </div>
