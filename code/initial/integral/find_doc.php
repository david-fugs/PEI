<?php
  ...
  include("../../../conexion.php");
	...
	$sql = "SELECT * FROM dllo_integ WHERE id_dllo_integ = '$id_dllo_integ'";
     ...
     <section class="principal">
      ...
      <div style="border-radius: 9px 9px 9px 9px; -moz-border-radius: 9px 9px 9px 9px; -webkit-border-radius: 9px 9px 9px 9px; border: 4px solid #FFFFFF;" align="center">
        ...
        <div align="center">
          ...
          <h1 style="color: #412fd1; font-size: 30px; text-shadow: #FFFFFF 0.1em 0.1em 0.2em"><b><i class="fas fa-folder-open"></i> DOCUMENTOS SEGUIMIENTO AL DESARROLLO INTEGRAL </b></h1>

        </div>

      <?php 
        $path = "files/".$id_dllo_integ;
