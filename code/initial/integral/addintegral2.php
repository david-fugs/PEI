<?php
    ...
    $sql = "INSERT INTO dllo_integ (obs_dllo_integ, id_cole, fecha_alta_dllo_integ, fecha_edit_dllo_integ, id_usu) values ('$obs_dllo_integ', '$id_cole','$fecha_alta_dllo_integ', '$fecha_edit_dllo_integ', '$id_usu')";
