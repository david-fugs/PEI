...
<body >
   	<?php
	    ...
	    {
	       $sql = mysqli_query($mysqli, "SELECT * FROM educa_inicial WHERE id_edu_ini = '$id_edu_ini'");
    ...
    ?>
   	...
   	<div class="container">
        ...
        <BR/>
        <h1><b><i class="fas fa-baby"></i> ACTUALIZAR INFORMACIÓN CAPÍTULO EDUCACIÓN INICIAL </b></h1>
        <p><i><b><font size=3 color=#c68615>*Datos obligatorios</i></b></font></p>
    
        <form action='addeducaedit1.php' enctype="multipart/form-data" method="POST">
            <div class="row">
                <div class="col">
                    <input type="number" name='id_edu_ini' class='form-control' hidden value='<?php echo $row['id_edu_ini']; ?>' />
                </div>  
            </div>
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-12 col-sm-12">
                        <label for="obs_edu_ini">OBSERVACIONES y/o COMENTARIOS ADICIONALES: (número de caracteres permitido-> <span></span>)</label>
                        <textarea class="form-control" rows="5" cols="124" name="obs_edu_ini" maxlength="10000" style="text-transform:uppercase;" /><?php echo $row['obs_edu_ini']; ?></textarea>
                    </div>
                </div>
            </div>
