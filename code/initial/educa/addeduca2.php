<?php
    ...
    $obs_edu_ini            = isset($_POST['obs_edu_ini']) ? strtoupper($_POST['obs_edu_ini']) : '';
    // Usar el id_cole de la sesión si no viene del POST o si el POST está vacío
    $id_cole_post           = isset($_POST['id_cole']) ? $_POST['id_cole'] : '';
    $id_cole_final          = !empty($id_cole_post) ? $id_cole_post : $id_cole;
    $fecha_alta_edu_ini     = date('Y-m-d H:i:s');
    $fecha_edit_edu_ini     = '0000-00-00 00:00:00';
    $id_usu                 = $_SESSION['id'];

    // Validar que tenemos un id_cole válido
            ...
            <html lang='es'>
                ...
                <body>
                    <script>
                        Swal.fire({
                            title: 'Error',
                            text: 'No se pudo obtener el ID del colegio. Por favor, inicie sesión nuevamente.',
                            icon: 'error',
    ...
    try {
        $sql = "INSERT INTO educa_inicial (obs_edu_ini, id_cole, fecha_alta_edu_ini, fecha_edit_edu_ini, id_usu) VALUES (?, ?, ?, ?, ?)";
        $stmt = $mysqli->prepare($sql);
        $stmt->bind_param("sissi", $obs_edu_ini, $id_cole_final, $fecha_alta_edu_ini, $fecha_edit_edu_ini, $id_usu);
                    ...
                    <div class='container'>
                        <center>
                            ...
                            <div class='mt-4'>
                                ...
                                <p class='text-muted'>El Capitulo de Educacion Inicial ha sido registrado correctamente</p>";
        ...
        echo "
                                <div class='mt-4'>
                                    <button class='btn btn-primary' onclick='volverInicio()'>
                                        <i class='fas fa-arrow-left'></i> Volver al Capitulo Inicial
                                    </button>
                                </div>
                            </div>
                        </center>
                    ...
                    <script>
                        ...
                        Swal.fire({
                            title: 'Exito!',
                            text: 'El Capitulo de Educacion Inicial se ha guardado correctamente',
                            icon: 'success',
                            confirmButtonText: 'OK',
                        ...
                        function volverInicio() {
                            Swal.fire({
                                title: 'Redirigiendo...',
                                text: 'Volviendo al menu de Educacion Inicial',
                                icon: 'info',
                                timer: 2000,
                                ...
                                window.location.href = 'addeduca.php';
                            });
                        }
                    </script>
                </body>
                ...
                <body>
                    <script>
                        Swal.fire({
                            ...
                            window.location.href = 'addeduca1.php';
                        });
                    </script>
                </body>
            </html>
