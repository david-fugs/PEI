...
<body>
   	...
   	<?php
        ...
        {
            $id_edu_ini         =   $_POST['id_edu_ini'];
            $obs_edu_ini        =   strtoupper($_POST['obs_edu_ini']);
            $id_cole            =   $_POST['id_cole'];
            $fecha_edit_edu_ini =   date('Y-m-d h:i:s');
            $id_usu             =   $_SESSION['id'];
           
            $update = "UPDATE educa_inicial SET obs_edu_ini='".$obs_edu_ini."', id_cole='".$id_cole."', fecha_edit_edu_ini='".$fecha_edit_edu_ini."', id_usu='".$id_usu."' WHERE id_edu_ini='".$id_edu_ini."'";

            $up = mysqli_query($mysqli, $update);

            $id_insert = $id_edu_ini;
