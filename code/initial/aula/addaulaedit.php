...
<body >
   	<?php
	    ...
	    $id_plan_aula  = $_GET['id_plan_aula'];
	    if(isset($_GET['id_plan_aula']))
	    {
	       $sql = mysqli_query($mysqli, "SELECT * FROM plan_aula WHERE id_plan_aula = '$id_plan_aula'");
    ...
    ?>
   	...
   	<div class="container">
        ...
        <BR/>
        <h1><b><i class="fas fa-baby"></i> ACTUALIZAR INFORMACIÓN PLAN DE AULA </b></h1>
        <p><i><b><font size=3 color=#c68615>*Datos obligatorios</i></b></font></p>
    
        <form action='addaulaedit1.php' enctype="multipart/form-data" method="POST">
            <div class="row">
                <div class="col">
                    <input type="number" name='id_plan_aula' class='form-control' hidden value='<?php echo $row['id_plan_aula']; ?>' />
                </div>  
            </div>
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-12 col-sm-12">
                        <label for="obs_plan_aula">OBSERVACIONES y/o COMENTARIOS ADICIONALES: (número de caracteres permitido-> <span></span>)</label>
                        <textarea class="form-control" rows="5" cols="124" name="obs_plan_aula" maxlength="10000" style="text-transform:uppercase;" /><?php echo $row['obs_plan_aula']; ?></textarea>
                    </div>
                </div>
            </div>
