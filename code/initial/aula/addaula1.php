...
?>
		...
		<div class="container">
			<h1><b><i class="fas fa-baby"></i> PLAN DE AULA</b></h1>
			<p><i><b><font size=3 color=#c68615>*Datos obligatorios</i></b></font></p>

			<form action='addaula2.php' enctype="multipart/form-data" method="POST">
				
				<div class="form-group">
                	<div class="row">
	                    <div class="col-12">
	                        <p style="font-family: 'Rajdhani', sans-serif; color: #000000; text-align: justify;">Debe contener los proyectos pedagógicos que se trabajarán durante el año y deben estar enmarcados desde los referentes técnicos de la Educación Inicial (Propósitos de la Educación Inicia, DBA, Actividades Rectoras, Seguimiento al Desarrollo Integral)<BR><br>
	                        <B>Se procede a cargar el Plan de Aula de Transición 2021.</B></p>
				...
				<div class="form-group">
	                <div class="row">
	                    <div class="col-12 col-sm-12">
	                        <label for="obs_plan_aula">OBSERVACIONES y/o COMENTARIOS ADICIONALES (número de caracteres permitido-> <span></span>)</label></label>
	                        <textarea class="form-control" rows="7" cols="124" name="obs_plan_aula" maxlength="10000" style="text-transform:uppercase;" ></textarea>
                		</div>
	                </div>
            	</div>
