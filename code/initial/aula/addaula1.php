		...
		<script>
	        function ordenarSelect(id_componente)
	          ...
	          $(document).ready(function () {
	            ...
	            $('#planAulaForm').on('submit', function(e) {
	                e.preventDefault();
	                
	                Swal.fire({
	                    title: '¿Esta seguro?',
	                    text: "Se guardara el Plan de Aula con la informacion proporcionada",
	                    icon: 'question',
		...
		<div class="container">
			<div class="main-container">
				<div class="form-header">
					<h1><i class="fas fa-baby"></i> PLAN DE AULA</h1>
				</div>
				...
				<form id="planAulaForm" action='addaula2.php' enctype="multipart/form-data" method="POST">
					
					<div class="info-text">
						<i class="fas fa-info-circle"></i>
						<strong>Informacion:</strong> Debe contener los proyectos pedagogicos que se trabajaran durante el ano y deben estar enmarcados desde los referentes tecnicos de la Educacion Inicial (Propositos de la Educacion Inicial, DBA, Actividades Rectoras, Seguimiento al Desarrollo Integral)<br><br>
						<strong>Se procede a cargar el Plan de Aula de Transicion 2021.</strong>
					</div>
					...
					<div class="form-group">
						<label for="obs_plan_aula"><i class="fas fa-comment-alt"></i> <strong>OBSERVACIONES y/o COMENTARIOS ADICIONALES</strong></label>
						...
						<textarea class="observaciones-textarea" name="obs_plan_aula" rows="5" maxlength="10000" placeholder="Ingrese sus observaciones y comentarios adicionales aqui..." style="width: 100%; border: 1px solid #ccc; padding: 10px; font-size: 14px; min-height: 80px; box-sizing: border-box; resize: vertical;"></textarea>
					</div>

					<div class="form-group">
						<label for="archivo"><i class="fas fa-file-pdf"></i> <strong>ADJUNTAR DOCUMENTOS DEL PLAN DE AULA</strong></label>
					...
					<div class="text-center mt-4">
						<button type="submit" class="btn btn-primary btn-lg mr-3">
							...
							GUARDAR y/o ALMACENAR DATOS PLAN DE AULA
						</button>
