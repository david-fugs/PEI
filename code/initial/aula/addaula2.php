<?php
    ...
    $obs_plan_aula          = isset($_POST['obs_plan_aula']) ? strtoupper($_POST['obs_plan_aula']) : '';
    ...
    $fecha_alta_plan_aula   = date('Y-m-d H:i:s');
    $fecha_edit_plan_aula   = '0000-00-00 00:00:00';
    $id_usu                 = $_SESSION['id'];
    ...
    try {
        $sql = "INSERT INTO plan_aula (obs_plan_aula, id_cole, fecha_alta_plan_aula, fecha_edit_plan_aula, id_usu) VALUES (?, ?, ?, ?, ?)";
        $stmt = $mysqli->prepare($sql);
        $stmt->bind_param("sissi", $obs_plan_aula, $id_cole_final, $fecha_alta_plan_aula, $fecha_edit_plan_aula, $id_usu);
                    ...
                    <div class='container'>
                        <center>
                            ...
                            <div class='mt-4'>
                                ...
                                <p class='text-muted'>El Plan de Aula ha sido registrado correctamente</p>";
        ...
        echo "
                                <div class='mt-4'>
                                    <button class='btn btn-primary' onclick='volverInicio()'>
                                        <i class='fas fa-arrow-left'></i> Volver al Plan de Aula
                                    </button>
                                </div>
                            </div>
                        </center>
                    ...
                    <script>
                        ...
                        Swal.fire({
                            title: 'Exito!',
                            text: 'El Plan de Aula se ha guardado correctamente',
                            icon: 'success',
                            confirmButtonText: 'OK',
                        ...
                        function volverInicio() {
                            Swal.fire({
                                title: 'Redirigiendo...',
                                text: 'Volviendo al menu de Plan de Aula',
                                icon: 'info',
                                timer: 2000,
                                ...
                                window.location.href = 'addaula.php';
                            });
                        }
                    </script>
                </body>
                ...
                <body>
                    <script>
                        Swal.fire({
                            ...
                            window.location.href = 'addaula1.php';
                        });
                    </script>
                </body>
            </html>
