...
<body>
   	...
   	<?php
        ...
        {
            $id_plan_aula           =   $_POST['id_plan_aula'];
            $obs_plan_aula          =   strtoupper($_POST['obs_plan_aula']);
            $id_cole                =   $_POST['id_cole'];
            $fecha_edit_plan_aula   =   date('Y-m-d h:i:s');
            $id_usu                 =   $_SESSION['id'];
           
            $update = "UPDATE plan_aula SET obs_plan_aula='".$obs_plan_aula."', id_cole='".$id_cole."', fecha_edit_plan_aula='".$fecha_edit_plan_aula."', id_usu='".$id_usu."' WHERE id_plan_aula='".$id_plan_aula."'";

            $up = mysqli_query($mysqli, $update);

            $id_insert = $id_plan_aula;
