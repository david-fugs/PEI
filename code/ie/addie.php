    ...
    <body>
		...
		<section class="principal">
			...
			<div style="border-radius: 9px 9px 9px 9px; -moz-border-radius: 9px 9px 9px 9px; -webkit-border-radius: 9px 9px 9px 9px; border: 4px solid #FFFFFF;" align="center">
				...
				<div align="center">
					<h1 style="color: #412fd1; font-size: 30px; text-shadow: #FFFFFF 0.1em 0.1em 0.2em"><b><i class="fas fa-school"></i> INFORMACIÓN SOBRE EL ESTABLECIMIENTOS EDUCATIVO</b></h1>
				</div>
	    		<br />
	...
	while($row = mysqli_fetch_array($result))
	{
		...
		echo '
				<tr>
					...
					<td data-label="RECTOR">'.$row['nombre_rector_cole'].'</td>
					<td data-label="RESOLUCIÓN">'.$row['num_act_adm_cole'].'</td>
					<td data-label="ARCHIVOS"><a href="find_doc.php?nit_cole='.$row['nit_cole'].'"><img src="../../img/files.png" width=28 heigth=28></td>
					<td data-label="EDIT"><a href="addieedit.php?cod_dane_cole='.$row['cod_dane_cole'].'"><img src="../../img/editar.png" width=20 heigth=20></td>
				</tr>';
	}
