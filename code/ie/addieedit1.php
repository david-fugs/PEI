...
<body>
   	...
   	<?php
	    ...
	    if(isset($_POST['btn-update']))
        {
            ...
            $update = "UPDATE colegios SET nit_cole='".$nit_cole."', nombre_cole='".$nombre_cole."', nombre_rector_cole='".$nombre_rector_cole."', tel_rector_cole='".$tel_rector_cole."', jor_1_cole='".$jor_1_cole."', jor_2_cole='".$jor_2_cole."', jor_3_cole='".$jor_3_cole."', jor_4_cole='".$jor_4_cole."', jor_5_cole='".$jor_5_cole."', jor_6_cole='".$jor_6_cole."', jor_7_cole='".$jor_7_cole."', jor_8_cole='".$jor_8_cole."', jor_9_cole='".$jor_9_cole."', jor_10_cole='".$jor_10_cole."', niv_1_cole='".$niv_1_cole."', niv_2_cole='".$niv_2_cole."', niv_3_cole='".$niv_3_cole."', niv_4_cole='".$niv_4_cole."', car_med_1_cole='".$car_med_1_cole."', car_med_2_cole='".$car_med_2_cole."', direccion_cole='".$direccion_cole."', corregimiento_cole='".$corregimiento_cole."', id_mun='".$id_mun."', tel1_cole='".$tel1_cole."', tel2_cole='".$tel2_cole."', email_cole='".$email_cole."', num_act_adm_cole='".$num_act_adm_cole."', fec_res_cole='".$fec_res_cole."', obs_cole='".$obs_cole."', fecha_edit_cole='".$fecha_edit_cole."', id_usu='".$id_usu."' WHERE cod_dane_cole='".$cod_dane_cole."'";
