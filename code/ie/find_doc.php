<?php
  ...
  include("../../conexion.php");
	...
	$nit_cole = $_GET['nit_cole'];
  
	$sql = "SELECT * FROM colegios WHERE nit_cole = '$nit_cole'";
     ...
     <section class="principal">
      ...
      <div style="border-radius: 9px 9px 9px 9px; -moz-border-radius: 9px 9px 9px 9px; -webkit-border-radius: 9px 9px 9px 9px; border: 4px solid #FFFFFF;" align="center">
        ...
        <div align="center">
          ...
          <h1 style="color: #412fd1; text-shadow: #FFFFFF 0.1em 0.1em 0.2em"><b><i class="fas fa-folder-open"></i> DOCUMENTOS ESTABLECIMIENTO EDUCATIVO </b></h1>
