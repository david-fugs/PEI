...
<body>
    ...
    <div class="container">
        ...
        <form action='sieeedit1.php' enctype="multipart/form-data" method="POST">
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-12 col-sm-4">
                        ...
                        <option value=""></option>
                        <option value="SI" <?php if (utf8_encode($row['preg1_siee']) == "SI") {
                                                echo 'selected';
                                            } ?>>SI</option>
                        <option value="NO" <?php if (utf8_encode($row['preg1_siee']) == "NO") {
                                                echo 'selected';
                                            } ?>>NO</option>
                        </select>
                    </div>
                    <div class="col-12 col-sm-4">
                        ...
                        <option value=""></option>
                        <option value="SI" <?php if (utf8_encode($row['preg2_siee']) == "SI") {
                                                echo 'selected';
                                            } ?>>SI</option>
                        <option value="NO" <?php if (utf8_encode($row['preg2_siee']) == "NO") {
                                                echo 'selected';
                                            } ?>>NO</option>
                        </select>
                    </div>
                    <div class="col-12 col-sm-4">
                        ...
                        <select class="form-control" name="preg3_siee" required>
                            <option value=""></option>
                            <option value="SI" <?php if (utf8_encode($row['preg3_siee']) == "SI") {
                                                    echo 'selected';
                                                } ?>>SI</option>
                            <option value="NO" <?php if (utf8_encode($row['preg3_siee']) == "NO") {
                                                    echo 'selected';
                                                } ?>>NO</option>
                        </select>
                    </div>
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-4">
                        ...
                        <option value=""></option>
                        <option value=""></option>
                        <option value="SI" <?php if (utf8_encode($row['preg5_siee']) == "SI") {
                                                echo 'selected';
                                            } ?>>SI</option>
                        <option value="NO" <?php if (utf8_encode($row['preg5_siee']) == "NO") {
                                                echo 'selected';
                                            } ?>>NO</option>
                        </select>
                    </div>
            ...
            <h5><b>
                    <CENTER>6. Relacione la escala de valoración que se tiene para cada uno de los niveles y ciclos educativos que se manejan en el Establecimiento Educativo y los Modelos Educativos Flexibles que se tengan.</h5>
            </CENTER></b>
                ...
                <div class="row">
                    <div class="col-12 col-sm-6">
                        ...
                        <select class="form-control" name="preg8_siee" required>
                            <option value=""></option>
                            <option value="EVALUACION FORMATIVA" <?php if (utf8_encode($row['preg8_siee']) == "EVALUACION FORMATIVA") {
                                                                        echo 'selected';
                                                                    } ?>>EVALUACION FORMATIVA</option>
                            <option value="AUTOEVALUACION" <?php if (utf8_encode($row['preg8_siee']) == "AUTOEVALUACION") {
                                                                echo 'selected';
                                                            } ?>>AUTOEVALUACION</option>
                            <option value="COEVALUACION" <?php if (utf8_encode($row['preg8_siee']) == "COEVALUACION") {
                                                                echo 'selected';
                                                            } ?>>COEVALUACION</option>
                            <option value="HETEROEVALUACION" <?php if (utf8_encode($row['preg8_siee']) == "HETEROEVALUACION") {
                                                                    echo 'selected';
                                                                } ?>>HETEROEVALUACION</option>
                            <option value="TODAS LAS ANTERIORES" <?php if (utf8_encode($row['preg8_siee']) == "TODAS LAS ANTERIORES") {
                                                                        echo 'selected';
                                                                    } ?>>TODAS LAS ANTERIORES</option>
                            <option value="OTRA" <?php if (utf8_encode($row['preg8_siee']) == "OTRA") {
                                                        echo 'selected';
                                                    } ?>>OTRA</option>
                        </select>
                    </div>
                ...
                <div class="row">
                    <div class="col-12 col-sm-6">
                        ...
                        <select class="form-control" name="preg9_siee" required>
                            <option value=""></option>
                            <option value="SI" <?php if (utf8_encode($row['preg9_siee']) == "SI") {
                                                    echo 'selected';
                                                } ?>>SI</option>
                            <option value="NO" <?php if (utf8_encode($row['preg9_siee']) == "NO") {
                                                    echo 'selected';
                                                } ?>>NO</option>
                        </select>
                    </div>
                ...
                <div class="row">
                    <div class="col-12 col-sm-6">
                        ...
                        <select class="form-control" name="preg10_siee" required>
                            <option value=""></option>
                            <option value="SI" <?php if (utf8_encode($row['preg10_siee']) == "SI") {
                                                    echo 'selected';
                                                } ?>>SI</option>
                            <option value="NO" <?php if (utf8_encode($row['preg10_siee']) == "NO") {
                                                    echo 'selected';
                                                } ?>>NO</option>
                        </select>
                    </div>
                ...
                <div class="row">
                    <div class="col-12 col-sm-6">
                        ...
                        <select class="form-control" name="preg11_siee" required>
                            <option value=""></option>
                            <option value="BIMESTRAL" <?php if (utf8_encode($row['preg11_siee']) == "BIMESTRAL") {
                                                            echo 'selected';
                                                        } ?>>BIMESTRAL</option>
                            <option value="TRIMESTRAL" <?php if (utf8_encode($row['preg11_siee']) == "TRIMESTRAL") {
                                                            echo 'selected';
                                                        } ?>>TRIMESTRAL</option>
                            <option value="CUATRIMESTRAL" <?php if (utf8_encode($row['preg11_siee']) == "CUATRIMESTRAL") {
                                                                echo 'selected';
                                                            } ?>>CUATRIMESTRAL</option>
                            <option value="SEMESTRAL" <?php if (utf8_encode($row['preg11_siee']) == "SEMESTRAL") {
                                                            echo 'selected';
                                                        } ?>>SEMESTRAL</option>
                            <option value="OTRA" <?php if (utf8_encode($row['preg11_siee']) == "OTRA") {
                                                        echo 'selected';
                                                    } ?>>OTRA</option>
                        </select>
                    </div>
                ...
                <div class="row">
                    <div class="col-12 col-sm-6">
                        ...
                        <select class="form-control" name="preg12_siee" required>
                            <option value=""></option>
                            <option value="SI" <?php if (utf8_encode($row['preg12_siee']) == "SI") {
                                                    echo 'selected';
                                                } ?>>SI</option>
                            <option value="NO" <?php if (utf8_encode($row['preg12_siee']) == "NO") {
                                                    echo 'selected';
                                                } ?>>NO</option>
                        </select>
                    </div>
