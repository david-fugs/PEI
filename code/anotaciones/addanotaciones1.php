...
?>
		...
		<div class="container">
			<h1><b><i class="fas fa-chalkboard-teacher"></i> REGISTRO DE ANOTACIONES u OBSERVACIONES</b></h1>
			<p><i><b><font size=3 color=#c68615>*Datos obligatorios</i></b></font></p>

			<form action='addanotaciones2.php' enctype="multipart/form-data" method="POST">
                ...
                <div class="form-group">
                	<div class="row">
                    	<div class="col-12 col-sm-3">
	                        <label for="fecha_anot">* FECHA ANOTACIÓN:</label>
                        	<input type='date' name='fecha_anot' value='<?php echo $fecha;?>' class='form-control' readonly />
                    	</div>
                    	<div class="col-12 col-sm-5">
	                        <label for="tipo_anot">* SELECCIONE EL TIPO DE OBSERVACIÓN:</label>
	                        <select class="form-control" name="tipo_anot" required>
					            <option value=""></option>
					            <option value="ESTABLECIMIENTO EDUCATIVO">ESTABLECIMIENTO EDUCATIVO</option>
					            <option value="TELEOLOGICO">TELEOLOGICO</option> 
                ...
                <div class="form-group">
	                <div class="row">
	                    <div class="col-12 col-sm-12">
	                        <label for="obs_anot">OBSERVACIONES y/o COMENTARIOS:</label>
	                        <textarea class="form-control" rows="15" name="obs_anot" /></textarea>
                    	</div>
	                </div>
            	</div>
