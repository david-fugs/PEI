...
?>
		...
		<div class="container">
			<h1><b><i class="far fa-comment-edit"></i> SEGUIMIENTO A OBSERVACIONES GENERADAS</b></h1>
			<p><i><b><font size=3 color=#c68615>*Datos obligatorios</i></b></font></p>

			<form action='addobservaciones2.php' enctype="multipart/form-data" method="POST">
                ...
                <div class="form-group">
                	<div class="row">
                    	<div class="col-12 col-sm-3">
	                        <label for="fecha_seg">* FECHA ANOTACIÓN:</label>
                        	<input type='date' name='fecha_seg' value='<?php echo $fecha;?>' class='form-control' readonly />
                    	</div>
                    	<div class="col-12 col-sm-5">
	                        <label for="tipo_seg">* SELECCIONE LA OPCIÓN PARA DAR SEGUIMIENTO:</label>
	                        <select class="form-control" name="tipo_seg" required>
					            <option value=""></option>
					            <option value="ESTABLECIMIENTO EDUCATIVO">ESTABLECIMIENTO EDUCATIVO</option>
					            <option value="HORIZONTE INSTITUCIONAL">HORIZONTE INSTITUCIONAL</option> 
					            <option value="MALLAS">MALLAS</option> 
					            <option value="SIEE">SIEE</option> 
					            <option value="TRANSVERSALES">TRANSVERSALES</option> 
					            <option value="PROYECTOS y/o PLANES">PROYECTOS y/o PLANES</option> 
                ...
                <div class="form-group">
	                <div class="row">
	                    <div class="col-12 col-sm-12">
	                        <label for="obs_seg">COMENTARIOS SOBRE LAS OBSERVACIONES DEJADAS POR EL o LOS FUNCIONARIOS DE LA "SED":</label>
	                        <textarea class="form-control" rows="15" name="obs_seg" /></textarea>
                    	</div>
	                </div>
            	</div>
